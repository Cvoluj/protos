...
type RegisterRequest struct {
	...
	Passwrod string `protobuf:"bytes,2,opt,name=passwrod,proto3" json:"passwrod,omitempty"` // Password of the user to register
}
...
func (x *RegisterRequest) GetPasswrod() string {
	if x != nil {
		return x.Passwrod
	}
	return ""
...
type LoginRequest struct {
	...
	AppId    int32  `protobuf:"varint,3,opt,name=app_id,json=appId,proto3" json:"app_id,omitempty"` // ID of the app to login in
}
...
type IsAdminResponse struct {
	...
	IsAdmin bool `protobuf:"varint,1,opt,name=is_admin,json=isAdmin,proto3" json:"is_admin,omitempty"` // State of user admin status
}
...
var file_sso_sso_proto_rawDesc = []byte{
	...
	0x0a, 0x08, 0x70, 0x61, 0x73, 0x73, 0x77, 0x72, 0x6f, 0x64, 0x18, 0x02, 0x20, 0x01, 0x28, 0x09,
	0x52, 0x08, 0x70, 0x61, 0x73, 0x73, 0x77, 0x72, 0x6f, 0x64, 0x22, 0x2b, 0x0a, 0x10, 0x52, 0x65,
